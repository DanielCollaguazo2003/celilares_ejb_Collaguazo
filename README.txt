...
a persistence unit "celularesPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "celulares/pom.xml":
...
artifact ("celulares.war") is already built. You can build
